...
def draw_curve(current_epoch):
    ...
    if current_epoch == 0:
        ax0.legend()
        ax1.legend()
    fig.savefig( os.path.join(project_dir,'model',name,'train.jpg'))
...
def save_network(network, epoch_label):
    ...
    save_path = os.path.join(project_dir,'model',name,save_filename)
...
if not os.path.isdir(dir_name):
    os.mkdir(dir_name)
#record every run
copyfile(project_dir+'/train.py', dir_name+'/train.py')
copyfile(project_dir+'/model.py', dir_name+'/model.py')
