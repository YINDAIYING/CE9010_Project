...
config_path = os.path.join(project_dir,'model',opt.name,'opts.yaml')
...
def load_network(network):
    #save_path = os.path.join(project_dir,'model',name,'net_%s.pth'%opt.which_epoch)
...
os.system('python %sevaluate_gpu.py | tee -a %s'%(project_dir,result))
